...
<body>
  ...
  <header>
    ...
    <nav>
      ...
      <a href="../includes/tentangPelindoDesk.php">Tentang PelindoDesk</a>
      <a href="#">Kontak</a>
      <a href="../includes/detailProfil.php" class="icon-link"><span class="icon">👤</span></a>
    </nav>
  </header>
  ...
  <section class="aktivitas">
    ...
    <div class="aktivitas-grid">
      <a href="daftarTugas.php" class="aktivitas-card">
        <img src="../assets/img/list-task.jpg" alt="Daftar Tugas">
        <p>Daftar Tugas Karyawan</p>
      </a>
      <a href="rekapDivisi.php" class="aktivitas-card">
  ...
  <footer>
    <div class="footer-top">
      ...
      <div class="footer-col">
        <h3>Halaman</h3>
        <a href="../guest/login.php">Log Out</a>
        <a href="../includes/tentangPelindoDesk.php">Tentang Kami</a>
        <a href="#">FAQ</a>
      </div>
      <div class="footer-col">
        <h3>Dukungan</h3>
